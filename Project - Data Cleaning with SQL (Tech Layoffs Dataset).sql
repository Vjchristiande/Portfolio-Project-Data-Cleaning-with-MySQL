...
SELECT * -- NOTICED THAT THERE'S AN ISSUE IN SPACES
FROM layoffs_Staging2
...
DELETE -- DELETING ROWS WHERE PERCENTAGE_LAID_OFF AND FUNDS_RAISED ARE NULL. NOT USEFUL FOR THE FUTURE PROJECT.
FROM layoffs_staging2
WHERE percentage_laid_off IS NULL
AND funds_raised IS NULL;
